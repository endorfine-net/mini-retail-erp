  ...
  $.widget("ui.datetime", {
    ...
    _prepare: function(){
      ...
      if(!o.altFormat) this.options.altFormat = o.format;
			if (o.withDate){}else{o.value = "00:00"}
    ...
    _clock: function(){         
        ...
        '</div></div><table><thead><tr><th><span>час</span></th><th><span>мин</span></th></tr></thead><tbody>'+
      ...
      if(this.options.withDate) {this.clock.css('marginLeft', '.2em');
				...
				if (value){
					...
					this._clockSlider(0, 0, (24-o.stepHours), o.stepHours, 'hour');
					this._clockSlider(0, 0, (60-o.stepMins), o.stepMins, 'mins');		
				}
			}
      return this;
    },
