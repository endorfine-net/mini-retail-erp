//
// @author: Juarez Gonçalves Nery Junior - http://juareznjunior.wordpress.com
    ...
    $.fn.scrollTable = function(options){
        ...
        return this.each(function(){
            ...
            if (!$self.hasClass('hasGrid')) {
				...
				if ('undefined' == options.tableClassName || '' == options.tableClassName)
                    options.tableClassName = tableMainDOM.className
